...
export default function DashProfile() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(`https://emergi-net-web-services-6bzifphlj-prem-rajs-projects.vercel.app/api/user/update/${currentUser._id}`, {
        method: "PUT",
        headers: {
  ...
  const handleDeleteUser = async (e) => {
    ...
    try {
      ...
      const res = await fetch(`https://emergi-net-web-services-6bzifphlj-prem-rajs-projects.vercel.app/api/user/delete/${currentUser._id}`, {
        method: "DELETE",
      });
      const data = res.json();
      if (!res.ok) {
  ...
  const handleSignout = async () => {
    try {
      const res = await fetch("https://emergi-net-web-services-6bzifphlj-prem-rajs-projects.vercel.app/api/user/signout", {
        method: "POST",
      });
      const data = await res.json();
      if (!res.ok) {
